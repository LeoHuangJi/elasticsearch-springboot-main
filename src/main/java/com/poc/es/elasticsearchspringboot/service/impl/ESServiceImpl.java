...
public class ESServiceImpl implements ESService {
    ...
    public boolean bulkInsertProducts(List<Product> products) throws IOException {
       return esClientConnector.bulkInsertProducts(products);
    }
    ...
    public List<Employee> employeesCustomSearch(Employee employee) throws IOException {
        return esClientConnector.employeesCustomSearch(employee);
    }
    @Override
    public List<Product> productCustomSearch(Product product, int pageNumber, int pageSize) throws IOException {
        return esClientConnector.productCustomSearch(product,1,10);
    }
